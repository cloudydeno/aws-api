...
export interface DecryptRequest {
  CiphertextBlob: ByteArray | string;
...
export interface ImportKeyMaterialRequest {
  KeyId: string;
  ImportToken: ByteArray | string;
  EncryptedKeyMaterial: ByteArray | string;
...
export interface DecryptResponse {
  ...
  EncryptionAlgorithm?: EncryptionAlgorithmSpec | null;
  CiphertextForRecipient?: ByteArray | null;
}
...
export interface GenerateDataKeyPairResponse {
  PrivateKeyCiphertextBlob?: ByteArray | null;
  PrivateKeyPlaintext?: ByteArray | null;
...
export interface RecipientInfo {
  ...
  AttestationDocument?: ByteArray | string | null;
}
