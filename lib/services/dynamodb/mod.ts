...
export class DynamoDB {
  ...
  async createTable(
    ...
    const body: jsonP.JSONObject = {
      ...
      OnDemandThroughput: fromOnDemandThroughput(params["OnDemandThroughput"]),
    };
    const resp = await this.#client.performRequest({
      opts, body,
      action: "CreateTable",
  ...
  async deleteItem(
    ...
    const body: jsonP.JSONObject = {
      ...
      ReturnValuesOnConditionCheckFailure: params["ReturnValuesOnConditionCheckFailure"],
    };
    const resp = await this.#client.performRequest({
      opts, body,
      action: "DeleteItem",
  ...
  async describeImport(
    params: s.DescribeImportInput,
    opts: client.RequestOptions = {},
  ): Promise<s.DescribeImportOutput> {
    const body: jsonP.JSONObject = {
      ImportArn: params["ImportArn"],
    };
    const resp = await this.#client.performRequest({
      opts, body,
    ...
    return jsonP.readObj({
      required: {
        "ImportTableDescription": toImportTableDescription,
      },
      optional: {},
    }, await resp.json());
  }
  ...
  async disableKinesisStreamingDestination(
    ...
    const body: jsonP.JSONObject = {
      ...
      EnableKinesisStreamingConfiguration: fromEnableKinesisStreamingConfiguration(params["EnableKinesisStreamingConfiguration"]),
    };
    const resp = await this.#client.performRequest({
      opts, body,
    ...
    return jsonP.readObj({
      ...
      optional: {
        ...
        "EnableKinesisStreamingConfiguration": toEnableKinesisStreamingConfiguration,
      },
    }, await resp.json());
  }
  ...
  async exportTableToPointInTime(
    ...
    const body: jsonP.JSONObject = {
      ...
      IncrementalExportSpecification: fromIncrementalExportSpecification(params["IncrementalExportSpecification"]),
    };
    const resp = await this.#client.performRequest({
      opts, body,
  ...
  async importTable(
    params: s.ImportTableInput,
    opts: client.RequestOptions = {},
  ): Promise<s.ImportTableOutput> {
    const body: jsonP.JSONObject = {
      ClientToken: params["ClientToken"] ?? generateIdemptToken(),
      S3BucketSource: fromS3BucketSource(params["S3BucketSource"]),
      InputFormat: params["InputFormat"],
      InputFormatOptions: fromInputFormatOptions(params["InputFormatOptions"]),
      InputCompressionType: params["InputCompressionType"],
      TableCreationParameters: fromTableCreationParameters(params["TableCreationParameters"]),
    };
    const resp = await this.#client.performRequest({
      opts, body,
      action: "ImportTable",
  ...
  async listImports(
    ...
    return jsonP.readObj({
      required: {},
      optional: {
        "ImportSummaryList": [toImportSummary],
        "NextToken": "s",
      },
    }, await resp.json());
  }
  ...
  async putResourcePolicy(
    ...
    const body: jsonP.JSONObject = {
      ...
      ExpectedRevisionId: params["ExpectedRevisionId"],
      ConfirmRemoveSelfResourceAccess: params["ConfirmRemoveSelfResourceAccess"],
    };
    const resp = await this.#client.performRequest({
      opts, body,
  ...
  async restoreTableFromBackup(
    ...
    const body: jsonP.JSONObject = {
      ...
      OnDemandThroughputOverride: fromOnDemandThroughput(params["OnDemandThroughputOverride"]),
  ...
  async updateKinesisStreamingDestination(
    params: s.UpdateKinesisStreamingDestinationInput,
    opts: client.RequestOptions = {},
  ): Promise<s.UpdateKinesisStreamingDestinationOutput> {
    const body: jsonP.JSONObject = {
      TableName: params["TableName"],
      StreamArn: params["StreamArn"],
      UpdateKinesisStreamingConfiguration: fromUpdateKinesisStreamingConfiguration(params["UpdateKinesisStreamingConfiguration"]),
    };
    const resp = await this.#client.performRequest({
      opts, body,
      action: "UpdateKinesisStreamingDestination",
    });
    return jsonP.readObj({
      required: {},
      optional: {
        ...
        "StreamArn": "s",
        "DestinationStatus": (x: jsonP.JSONValue) => cmnP.readEnum<s.DestinationStatus>(x),
        "UpdateKinesisStreamingConfiguration": toUpdateKinesisStreamingConfiguration,
      },
    }, await resp.json());
  }
...
function fromGlobalSecondaryIndex(input?: s.GlobalSecondaryIndex | null): jsonP.JSONValue {
  ...
  return {
    ...
    OnDemandThroughput: fromOnDemandThroughput(input["OnDemandThroughput"]),
  }
}
function toGlobalSecondaryIndex(root: jsonP.JSONValue): s.GlobalSecondaryIndex {
  return jsonP.readObj({
    required: {
      "IndexName": "s",
    ...
    optional: {
      ...
      "OnDemandThroughput": toOnDemandThroughput,
    },
  }, root);
}
...
function fromOnDemandThroughput(input?: s.OnDemandThroughput | null): jsonP.JSONValue {
  if (!input) return input;
  return {
...
function toOnDemandThroughput(root: jsonP.JSONValue): s.OnDemandThroughput {
  return jsonP.readObj({
    required: {},
    optional: {
      "MaxReadRequestUnits": "n",
      "MaxWriteRequestUnits": "n",
    },
  }, root);
}
...
function toSSESpecification(root: jsonP.JSONValue): s.SSESpecification {
  return jsonP.readObj({
    required: {},
    optional: {
      "Enabled": "b",
...
function fromEnableKinesisStreamingConfiguration(input?: s.EnableKinesisStreamingConfiguration | null): jsonP.JSONValue {
  if (!input) return input;
  return {
    ApproximateCreationDateTimePrecision: input["ApproximateCreationDateTimePrecision"],
  }
}
function toEnableKinesisStreamingConfiguration(root: jsonP.JSONValue): s.EnableKinesisStreamingConfiguration {
  return jsonP.readObj({
    required: {},
    optional: {
      "ApproximateCreationDateTimePrecision": (x: jsonP.JSONValue) => cmnP.readEnum<s.ApproximateCreationDateTimePrecision>(x),
    },
  }, root);
}
...
function fromIncrementalExportSpecification(input?: s.IncrementalExportSpecification | null): jsonP.JSONValue {
  if (!input) return input;
  return {
    ExportFromTime: jsonP.serializeDate_unixTimestamp(input["ExportFromTime"]),
    ExportToTime: jsonP.serializeDate_unixTimestamp(input["ExportToTime"]),
    ExportViewType: input["ExportViewType"],
  }
}
function toIncrementalExportSpecification(root: jsonP.JSONValue): s.IncrementalExportSpecification {
  return jsonP.readObj({
    required: {},
    optional: {
      "ExportFromTime": "d",
      "ExportToTime": "d",
      "ExportViewType": (x: jsonP.JSONValue) => cmnP.readEnum<s.ExportViewType>(x),
    },
  }, root);
}

function fromS3BucketSource(input?: s.S3BucketSource | null): jsonP.JSONValue {
  if (!input) return input;
  return {
...
function toS3BucketSource(root: jsonP.JSONValue): s.S3BucketSource {
  return jsonP.readObj({
    required: {
      "S3Bucket": "s",
    },
...
function fromInputFormatOptions(input?: s.InputFormatOptions | null): jsonP.JSONValue {
  if (!input) return input;
  return {
    Csv: fromCsvOptions(input["Csv"]),
  }
}
function toInputFormatOptions(root: jsonP.JSONValue): s.InputFormatOptions {
  return jsonP.readObj({
    required: {},
    optional: {
      "Csv": toCsvOptions,
...
function fromTableCreationParameters(input?: s.TableCreationParameters | null): jsonP.JSONValue {
  if (!input) return input;
  return {
    TableName: input["TableName"],
    AttributeDefinitions: input["AttributeDefinitions"]?.map(x => fromAttributeDefinition(x)),
    KeySchema: input["KeySchema"]?.map(x => fromKeySchemaElement(x)),
    BillingMode: input["BillingMode"],
    ProvisionedThroughput: fromProvisionedThroughput(input["ProvisionedThroughput"]),
    OnDemandThroughput: fromOnDemandThroughput(input["OnDemandThroughput"]),
    SSESpecification: fromSSESpecification(input["SSESpecification"]),
    GlobalSecondaryIndexes: input["GlobalSecondaryIndexes"]?.map(x => fromGlobalSecondaryIndex(x)),
  }
}
function toTableCreationParameters(root: jsonP.JSONValue): s.TableCreationParameters {
  return jsonP.readObj({
    required: {
      "TableName": "s",
    ...
    optional: {
      ...
      "GlobalSecondaryIndexes": [toGlobalSecondaryIndex],
    },
  }, root);
}
...
function fromUpdateKinesisStreamingConfiguration(input?: s.UpdateKinesisStreamingConfiguration | null): jsonP.JSONValue {
  if (!input) return input;
  return {
    ApproximateCreationDateTimePrecision: input["ApproximateCreationDateTimePrecision"],
  }
}
function toUpdateKinesisStreamingConfiguration(root: jsonP.JSONValue): s.UpdateKinesisStreamingConfiguration {
  return jsonP.readObj({
    required: {},
    optional: {
      "ApproximateCreationDateTimePrecision": (x: jsonP.JSONValue) => cmnP.readEnum<s.ApproximateCreationDateTimePrecision>(x),
...
function fromCreateReplicationGroupMemberAction(input?: s.CreateReplicationGroupMemberAction | null): jsonP.JSONValue {
  ...
  return {
    ...
    OnDemandThroughputOverride: fromOnDemandThroughputOverride(input["OnDemandThroughputOverride"]),
...
function fromOnDemandThroughputOverride(input?: s.OnDemandThroughputOverride | null): jsonP.JSONValue {
  if (!input) return input;
  return {
    MaxReadRequestUnits: input["MaxReadRequestUnits"],
  }
}
function toOnDemandThroughputOverride(root: jsonP.JSONValue): s.OnDemandThroughputOverride {
  return jsonP.readObj({
    required: {},
    optional: {
      "MaxReadRequestUnits": "n",
...
function toReplicaDescription(root: jsonP.JSONValue): s.ReplicaDescription {
  return jsonP.readObj({
    ...
    optional: {
      ...
      "OnDemandThroughputOverride": toOnDemandThroughputOverride,
...
function toExportDescription(root: jsonP.JSONValue): s.ExportDescription {
  return jsonP.readObj({
    ...
    optional: {
      ...
      "IncrementalExportSpecification": toIncrementalExportSpecification,
    },
  }, root);
}
...
function toImportTableDescription(root: jsonP.JSONValue): s.ImportTableDescription {
  return jsonP.readObj({
    required: {},
    optional: {
      "ImportArn": "s",
      ...
      "TableId": "s",
      "ClientToken": "s",
      "S3BucketSource": toS3BucketSource,
      "ErrorCount": "n",
      "CloudWatchLogGroupArn": "s",
      "InputFormat": (x: jsonP.JSONValue) => cmnP.readEnum<s.InputFormat>(x),
      "InputFormatOptions": toInputFormatOptions,
      "InputCompressionType": (x: jsonP.JSONValue) => cmnP.readEnum<s.InputCompressionType>(x),
      "TableCreationParameters": toTableCreationParameters,
      "StartTime": "d",
      "EndTime": "d",
      "ProcessedSizeBytes": "n",
      "ProcessedItemCount": "n",
      "ImportedItemCount": "n",
      "FailureCode": "s",
      "FailureMessage": "s",
    },
...
function toImportSummary(root: jsonP.JSONValue): s.ImportSummary {
  return jsonP.readObj({
    required: {},
    optional: {
      "ImportArn": "s",
